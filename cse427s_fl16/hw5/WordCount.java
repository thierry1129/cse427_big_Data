...
public class WordCount {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DistributedCache.addCacheFile(new URI ("positive-words.txt#positive-words.txt"), conf);
    
    DistributedCache.addCacheFile(new URI ("negative-words.txt#negative-words.txt"), conf);
